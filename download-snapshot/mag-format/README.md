...
{% hint style="danger" %}
**The MAG format is deprecated**. The MAG format snapshot was maintained and updated until July 7, 2022. Now, the [native-format snapshot](../) will be the only one supported.
{% endhint %}
