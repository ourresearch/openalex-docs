...
* [`apc_payment.price`](work-object/#apc\_payment)
* [`apc_payment.currency`](work-object/#apc\_payment)
* [`apc_payment.provenance`](work-object/#apc\_payment)
* [`apc_payment.price_usd`](work-object/#apc\_payment)
...
Returns: works whose abstract includes the given string. See the [search page](../../the-api/get-lists-of-entities/search-entities.md) for details on the search algorithm used.
...
Value: the [OpenAlex ID](../../the-api/get-single-entities/#the-openalex-id) for a given work
...
Returns: works whose[`display_name`](work-object/#display\_name) (title) includes the given string; see the [search page](../../the-api/get-lists-of-entities/search-entities.md) for details.
...
Value: the [OpenAlex ID](../../the-api/get-single-entities/#the-openalex-id) for a given [source](../sources/source-object.md), where the source is [`type: journal`](../sources/source-object.md#type)
...
Value: the [OpenAlex ID](../../the-api/get-single-entities/#the-openalex-id) for an [`Institution`](../institutions/)
...
Value: the [OpenAlex ID](../../the-api/get-single-entities/#the-openalex-id) for a [`Publisher`](../publishers/)
...
Returns: works that have at least one [`raw_affiliation_string`](work-object/#raw\_affiliation\_string) which includes the given string. See the [search page](../../the-api/get-lists-of-entities/search-entities.md) for details on the search algorithm used.
...
Value: the [OpenAlex ID](../../the-api/get-single-entities/#the-openalex-id) for a given [source](../sources/source-object.md), where the source is [`type: repository`](../sources/source-object.md#type)
