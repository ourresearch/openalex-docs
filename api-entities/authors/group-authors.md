...
* Get counts of authors by the last known institution continent:\
  [`https://api.openalex.org/authors?group_by=last_known_institutions.continent`](https://api.openalex.org/authors?group\_by=last\_known\_institutions.continent)``
...
* [`last_known_institutions.continent`](filter-authors.md#last\_known\_institution.continent)
...
* [`last_known_institutions.is_global_south`](filter-authors.md#last\_known\_institution.is\_global\_south)
