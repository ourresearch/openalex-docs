...
Most clients will handle this transparently; you'll get the data for author A2208157607 without knowing the redirect even happened. If you have stored Entity ID lists, you might as well replace the merged-away (deleted) ID to save the redirect next time.
