...
Filters narrow down lists or groups of entities to just those that meet a particular condition--specifically, a particular value for a particular attribute.
