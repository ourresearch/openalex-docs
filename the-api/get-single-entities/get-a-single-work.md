...
That will return a [`Work`](../../the-data/works/work-object/) object, describing everything OpenAlex knows about the work with that ID.
...
{% hint style="info" %}
You can make up to 50 of these queries at once by requesting a list of entities and filtering on IDs [using OR syntax](../get-lists-of-entities/filter-entity-lists.md#addition-or) ([tutorial](https://blog.ourresearch.org/fetch-multiple-dois-in-one-openalex-api-request/)).
{% endhint %}
...
You can use `select` to limit the fields that are returned in a work object. More details are [here](../get-lists-of-entities/select-fields.md).
